    ...
    return <div >
        <div className="px-3 border-b border-patchwork_black-300 pb-4">
            ...
            {guidelines.map((guideline) => {
                return <div key={guideline.id} className="mb-3 flex items-center gap-2">
                    <Avatar className='bg-patchwork_red-500 flex items-center justify-center' >
                        <AvatarFallback className='text-patchwork_black-600 font-semibold'>{guideline.id}</AvatarFallback>
                    </Avatar>
                    <p>{guideline.text}</p>
                </div>
            })}
        ...
        <div className="px-3 pt-4 border-b border-patchwork_black-300 pb-4">
            ...
            <p className='text-md'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur impedit accusantium veritatis cumque maxime adipisci. Sequi error asperiores atque unde? Aliquam ad neque, reprehenderit dolorem incidunt facilis reiciendis expedita quisquam.</p>
            <p className="font-semibold my-3">This is a Heading</p>
            <p className='text-md'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur impedit accusantium veritatis cumque maxime adipisci. </p>
            <p className="font-semibold my-3">Another Heading</p>
            <p className='text-md'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur impedit accusantium veritatis cumque maxime adipisci. </p>
            <div className="mt-4 flex item-center gap-2">
                <CalendarIcon width={20} height={20} />
                <p className="text-md">Created at Aug 8 2024 by
    ...
    return (
        <div className='pb-36'>
            ...
            <div className="cursor-pointer sm:mx-[-20px] grid grid-cols-2 text-center py-3 font-semibold ">
                <div onClick={() => setSelectedTab('posts')}
                    className={`${selectedTab === 'posts' ? 'border-b-2 border-white text-white' : 'text-patchwork_black-50 '}  pb-3`} >Posts</div>
                <div onClick={() => setSelectedTab('about')}
                    className={`${selectedTab === 'about' ? 'border-b-2 border-white text-white' : 'text-patchwork_black-50 '}  pb-3`}>About</div>
            </div>
