        ...
        <div className='py-3 border-b border-patchwork_black-100 flex items-center justify-between ' >
            <div className="flex items-center gap-3">
                <div className="border p-1 rounded-full">
                    <Image width={50} height={50} className='rounded-full' src={contributor.image} alt={contributor.name} />
                </div>
                <div className="">
                    <span className="block text-[15px] font-semibold">{contributor.name}</span>
                    <small className='text-patchwork_black-100'>{contributor.email}</small>
